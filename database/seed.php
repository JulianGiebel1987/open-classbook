...
echo "\nLogin-Daten (Anmeldung per E-Mail-Adresse):\n";
echo "  Admin:        admin@demo-schule.de / Admin2026!x\n";
echo "  Schulleitung: k.schmidt@demo-schule.de / Leitung2026!\n";
echo "  Sekretariat:  s.meyer@demo-schule.de / Sekret2026!!\n";
echo "  Lehrer:       m.mueller@demo-schule.de / Lehrer2026!a\n";
echo "  (weitere Lehrer: a.fischer@, h.weber@, l.becker@, t.hoffmann@demo-schule.de)\n";
echo "  Schüler:      Anmeldung mit generiertem Benutzernamen, z.B. m.braun / Schüler2026!\n";
