...
<form method="post" action="/settings">
    ...
    <div class="card">
        ...
        <p class="form-help">Deaktivierte Module werden in der Navigation fuer alle Nutzer ausgeblendet und sind nicht zugaenglich. Der Admin kann Module jederzeit hier wieder aktivieren.</p>
    ...
    <!-- ====================================================== -->
    <!-- Rollenzugriff fuer spezifische Module                  -->
    <!-- ====================================================== -->
    <div class="card">
        <h2>Modulzugriff fuer Schulleitung und Sekretariat</h2>
        <p class="form-help">Hier kann eingestellt werden, ob Schulleitung und Sekretariat auf bestimmte Module zugreifen duerfen. Wenn ein Modul hier deaktiviert wird, ist es fuer die jeweilige Rolle unsichtbar &mdash; unabhaengig von der globalen Moduleinstellung oben.</p>
