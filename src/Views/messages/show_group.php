...
<div class="card chat-card">
    ...
    <form method="post" action="/messages/groups/<?= (int) $groupId ?>" class="chat-input-form" id="chatForm" enctype="multipart/form-data">
        <?= \OpenClassbook\View::csrfField() ?>
        <div class="chat-input-wrapper">
            <textarea name="body" id="chatInput" class="form-control" rows="2"
                      placeholder="Nachricht an Gruppe schreiben..." maxlength="5000"></textarea>
