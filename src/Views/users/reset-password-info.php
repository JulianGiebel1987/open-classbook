...
<div class="card" style="max-width: 480px;">
    ...
    <p class="text-muted" style="margin-top: var(--spacing-sm);">Bitte notieren Sie das temporäre Passwort und teilen Sie es dem Nutzer mit. Es wird nur einmal angezeigt.</p>
    ...
    <p class="text-muted" style="margin-top: var(--spacing-sm); font-size: var(--font-size-sm);">Der Nutzer wird beim nächsten Login aufgefordert, das Passwort zu ändern.</p>
