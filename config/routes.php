...
$router->get('/messages/groups/new', [MessageController::class, 'newGroup'], [AuthMiddleware::class]);
$router->post('/messages/groups/new', [MessageController::class, 'createGroup'], [AuthMiddleware::class, CsrfMiddleware::class]);
